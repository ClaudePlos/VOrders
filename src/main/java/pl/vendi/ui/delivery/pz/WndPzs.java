 ...
 * @author Piotr
 */
public class WndPzs extends Window
{

    VerticalLayout vboxMain = new VerticalLayout();
    HorizontalLayout hboxTop = new HorizontalLayout();
    
    DocumentsTable tabOrders = new DocumentsTable("Dostawy",  VOConsts.DOC_TYPE_PZ);
    ...
    public WndPzs()
    {
        ...
        tabOrders.setDocumentTypes( new String[]{ VOConsts.DOC_TYPE_PZ } );
